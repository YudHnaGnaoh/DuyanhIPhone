                    ...
                    products.forEach(el => {
                        ...
                        while (i <= lastpage) {
                            if (i == res.products.current_page) {
                                str2+= `
                                    <li class="page-item active"><a class="page-link" href="brand.html?id=`+ id + `&page=` + i + `">` + i + `</a></li>
                                    `
                            }
                            else {
                                str2+= `
                                    <li class="page-item"><a class="page-link" href="brand.html?id=`+ id + `&page=`+i+`">`+i+`</a></li>
                                    `
                            }
                            i++;
